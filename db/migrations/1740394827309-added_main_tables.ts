...
export class AddedMainTables1740394827309 implements MigrationInterface {
    name = 'AddedMainTables1740394827309'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "accounts" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "balance" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL, CONSTRAINT "PK_5a7a02c20412299d198e097a8fe" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "account_transactions" ("id" SERIAL NOT NULL, "accountId" integer NOT NULL, "amount" integer NOT NULL, "description" character varying NOT NULL, "ObjectId" integer NOT NULL, "objectModel" character varying NOT NULL, CONSTRAINT "PK_bcfbf02d6acfb8fe417296f010d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "clients" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "phone" character varying NOT NULL, "deletedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_f1ab7cf3a5714dbc6bb4e1c28a4" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "warehouses" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "location" character varying NOT NULL, CONSTRAINT "PK_56ae21ee2432b2270b48867e4be" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "purchases" ("id" SERIAL NOT NULL, "providerId" integer NOT NULL, "userId" integer NOT NULL, "wareHouseId" integer NOT NULL, "totalAmount" numeric(10,3) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_1d55032f37a34c6eceacbbca6b8" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "stock_movements" ("id" SERIAL NOT NULL, "wareHouseDetailId" integer NOT NULL, "quantity" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "objectId" integer NOT NULL, "objectModel" character varying NOT NULL, CONSTRAINT "PK_57a26b190618550d8e65fb860e7" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "sales" ("id" SERIAL NOT NULL, "clientId" integer NOT NULL, "userId" integer NOT NULL, "wareHouseId" integer NOT NULL, "cashRegisterId" integer NOT NULL, "totalAmount" numeric(10,3) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_4f0bc990ae81dba46da680895ea" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "warehouse_details" ("id" SERIAL NOT NULL, "warehouseId" integer NOT NULL, "productId" integer NOT NULL, "quantity" integer NOT NULL, CONSTRAINT "PK_4ea6900bc2ad9068c46d69097c8" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "purchases" ADD CONSTRAINT "FK_9379d15838258a8b57fae6f1b9d" FOREIGN KEY ("providerId") REFERENCES "providers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "purchases" ADD CONSTRAINT "FK_803645ac7c22fa8b5e4b283a67c" FOREIGN KEY ("wareHouseId") REFERENCES "warehouses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "sales" ADD CONSTRAINT "FK_67b7b325f3606310e6f5e52526a" FOREIGN KEY ("wareHouseId") REFERENCES "warehouses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
