...
export class AddedMainTables1741477929985 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "sales" ("id" SERIAL NOT NULL, "clientId" integer NOT NULL, "userId" integer NOT NULL, "cashRegisterId" integer NOT NULL, "totalAmount" numeric(10,3) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_4f0bc990ae81dba46da680895ea" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "sales" DROP CONSTRAINT "FK_92c1dc2d2514d50b4fb78c50f32"`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "sale_details" DROP CONSTRAINT "FK_3359bf44dc92a82a768f8f6bc37"`
    );
    await queryRunner.query(
      `ALTER TABLE "sale_details" DROP CONSTRAINT "FK_d7fef51a6c57924613bdb3980cd"`
    );
    await queryRunner.query(
      `ALTER TABLE "products" DROP CONSTRAINT "FK_2135007a246ddab8cbd4ef2bfce"`
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_a68c42eec57901a8ef2024a2be"`
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_89310f851ac91824fe807f895a"`
    );
