...
@Controller('warehouse_details')
export class WarehouseDetailsController {
    constructor(private readonly warehouseDetailsService: WarehouseDetailsService) {}
    ...
    @Patch(':id')
    update(@Param('id', ParseIntPipe) id: number, @Body() updateWarehouseDetailDto: UpdateWarehouseDetailDto) {
